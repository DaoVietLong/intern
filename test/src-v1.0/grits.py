...
def grits_from_html(true_html, pred_html):
    ...
    print ("grits_from_html.true_cells=", true_cells)
    print ("grits_from_html.pred_cells=", pred_cells)
    
    # Convert lists of cells to matrices of grid cells
    relspan_true_cells = cells_to_relspan_grid(true_cells)
    relspan_pred_cells = cells_to_relspan_grid(pred_cells)
    
    print ("relspan_true_cells")
    print (relspan_true_cells)
    print ("relspan_pred_cells")
    print (relspan_pred_cells)
    
    true_topology_grid = np.array(relspan_true_cells)
    pred_topology_grid = np.array(relspan_pred_cells)
